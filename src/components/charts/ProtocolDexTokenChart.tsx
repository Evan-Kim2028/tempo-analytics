...
import type { ProtocolDexTokenDailyStat } from '@/lib/analytics'

const PALETTE = [
  '#8B5CF6', '#10B981', '#0057FF', '#F59E0B',
...
function CustomLegend({ tokens, total }: {
  tokens: ProtocolDexTokenDailyStat['tokens']
  total: number
}) {
  return (
...
export function ProtocolDexTokenChart({ data }: { data: ProtocolDexTokenDailyStat }) {
