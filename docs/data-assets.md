...
| `mv_fee_token_amount_daily` | chain | Daily fee token USD amounts paid (gas_used × effective_gas_price / 1e18) | `tidx_4217.receipts`, `tidx_4217.txs` | `src/app/dex/page.tsx`, `src/lib/analytics.ts` | `sql/clickhouse/views/chain/mv_fee_token_amount_daily.sql` | `sql/clickhouse/backfills/chain/mv_fee_token_amount_daily.sql` |
...
| `mv_micropayment_stats_daily` | payments | Daily micropayment tier rollups — counts and USD amounts by value bucket for dashboard charts | `tidx_4217.logs` | `src/lib/payments.ts::getMicropaymentStatsDaily`, `getMicropaymentStatsSummary` | `sql/clickhouse/views/payments/mv_micropayment_stats_daily.sql` | `sql/clickhouse/backfills/payments/mv_micropayment_stats_daily.sql` |
| `mv_stablecoin_daily` | stablecoins | Daily transfer volume for whitelisted stablecoins (mirrors tokenlist.tempo.xyz) | `tidx_4217.logs` | `src/app/analytics/page.tsx`, `src/app/stablecoins/page.tsx`, `src/lib/analytics.ts` | `sql/clickhouse/views/stablecoins/mv_stablecoin_daily.sql` | `sql/clickhouse/backfills/stablecoins/mv_stablecoin_daily.sql` |
